...
/*   Updated: 2024/10/16 11:26:03 by jsamardz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// printf("Before rotation: angle = %f\n", mlx->ply->ply_angle);
...
{
	if (mlx->ply->up_down == 1)			// 0 to 1 not moving, but 0 to -1 moving and adding that small movment overtime
	{
